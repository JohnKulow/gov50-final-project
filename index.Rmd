...
For my data, I use a combination of two data sets. First, I use the Historical Index of Ethnic Fractionalization (HIEF), as compiled by Lenka Drazanova in 2019. This data set includes annual measures of ethnic fractionalization, which is the percent chance that any two residents of a certain country are from differing ethnic groups, for 162 countries over a 69 year period. The second data set I use is the "Civil Wars" data set provided by Professor Blackwell. This data set includes data over a 55-year period concerning which countries experienced civil wars, when they did, and for how long. This data set also includes two additional measures for ethnic fractionalization that use slightly different methodologies.
